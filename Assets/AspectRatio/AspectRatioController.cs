...
#region WINAPI
	...
	void OnWindowsFun(int windowId)
	{
		...
		if (GUILayout.Button("设计分辨率"))
		{
			...
			SetWindowPos(unityHWnd, IntPtr.Zero, windowRect.Left, windowRect.Top, 
				mDefaultWidth + borderWidth, mDefaultHeight + borderHeight, SWP_NOMOVE);
